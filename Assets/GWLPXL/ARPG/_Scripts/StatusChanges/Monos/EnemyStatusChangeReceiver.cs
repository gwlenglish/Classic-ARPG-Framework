...
{
   /// <summary>
   /// Status effects wont carry over between scenes at the moment, would need to hold a status effect controller. TO DO
   /// </summary>

    public class EnemyStatusChangeReceiver : MonoBehaviour, IRecieveStatusChanges
    {
